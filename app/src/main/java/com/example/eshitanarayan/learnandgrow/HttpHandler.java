...
public class HttpHandler {
    ...
    private static final String TAG = com.example.eshitanarayan.learnandgrow.HttpHandler.class.getSimpleName();

    public HttpHandler() {
    }

    public String makeServiceCall(String reqUrl,String email,String password)
    {
